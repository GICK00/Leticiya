...
{
    internal class InteractionDataAdmin
    {
                    ...
                    switch (Program.formMain.comboBox.Text)
                    {
                        case "Employee":
                            ...
                            else
                            {
                                if (action == "Update")
                                {
                                    sqlCommand.Parameters.Add(new NpgsqParameter("@ID", SqlDbType.Int));
                                    sqlCommand.Parameters["@ID"].Value = array[0];
                                }

                                sqlCommand.Parameters.Add(new NpgsqParameter("@EMPLOYEE_SURNAME", SqlDbType.NChar, 25));
                                sqlCommand.Parameters["@EMPLOYEE_SURNAME"].Value = EmployeeFIO[0];

                                sqlCommand.Parameters.Add(new NpgsqParameter("@EMPLOYEE_NAME", SqlDbType.NChar, 25));
                                sqlCommand.Parameters["@EMPLOYEE_NAME"].Value = EmployeeFIO[1];

                                if (EmployeeFIO.Length > 2)
                                {
                                    sqlCommand.Parameters.Add(new NpgsqParameter("@EMPLOYEE_PATRONYMIC", SqlDbType.NChar, 25));
                                    sqlCommand.Parameters["@EMPLOYEE_PATRONYMIC"].Value = EmployeeFIO[2];
                                }

                                sqlCommand.Parameters.Add(new NpgsqParameter("@EMPLOYEE_POSITION", SqlDbType.NChar, 25));
                                sqlCommand.Parameters["@EMPLOYEE_POSITION"].Value = Program.formMain.textBox4.Text;

                                sqlCommand.Parameters.Add(new NpgsqParameter("@DEPARTAMENT_ID", SqlDbType.Int));
                                sqlCommand.Parameters["@DEPARTAMENT_ID"].Value = Convert.ToInt32(Program.formMain.textBox5.Text);

                                sqlCommand.Parameters.Add(new NpgsqParameter("@EMPLOYEE_WORK_TELEPHONE", SqlDbType.NVarChar, 12));
                                sqlCommand.Parameters["@EMPLOYEE_WORK_TELEPHONE"].Value = Program.formMain.textBox6.Text;

                                sqlCommand.Parameters.Add(new NpgsqParameter("@EMPLOYEE_WORK_TIME", SqlDbType.NChar, 15));
                        ...
                        case "Programmer":
                            ...
                            else
                            {
                                ...
                                sqlCommand.Parameters.Add(new NpgsqParameter("@PROGRAMMER_SURNAME", SqlDbType.NChar, 25));
                                sqlCommand.Parameters["@PROGRAMMER_SURNAME"].Value = ProgrammerFIO[0];

                                sqlCommand.Parameters.Add(new NpgsqParameter("@PROGRAMMER_NAME", SqlDbType.NChar, 25));
                                sqlCommand.Parameters["@PROGRAMMER_NAME"].Value = ProgrammerFIO[1];

                                if (ProgrammerFIO.Length > 2)
                                {
                                    sqlCommand.Parameters.Add(new NpgsqParameter("@PROGRAMMER_PATRONYMIC", SqlDbType.NChar, 25));
                                ...
                                sqlCommand.Parameters.Add(new NpgsqParameter("@PROGRAMMER_WORK_TELEPHONE", SqlDbType.NVarChar, 12));
                                sqlCommand.Parameters["@PROGRAMMER_WORK_TELEPHONE"].Value = Program.formMain.textBox10.Text;

                                sqlCommand.Parameters.Add(new NpgsqParameter("@PROGRAMMER_WORK_TIME", SqlDbType.NChar, 15));
                        ...
                        case "Task":
                            ...
                            else
                            {
                                ...
                                sqlCommand.Parameters.Add(new NpgsqParameter("@TASK_NAME", SqlDbType.NChar, 30));
                                ...
                                sqlCommand.Parameters.Add(new NpgsqParameter("@TASK_DATA", SqlDbType.DateTime));
                                ...
                                if (Program.formMain.textBox12.Text.Length != 0)
                                {
                                    ...
                                    sqlCommand.Parameters.Add(new NpgsqParameter("@TASK_COMPLETION_DATA", SqlDbType.DateTime));
                                    sqlCommand.Parameters["@TASK_COMPLETION_DATA"].Value = dataCompletion.ToString("dd-MM-yyyy HH:mm:ss");
                                }

                                sqlCommand.Parameters.Add(new NpgsqParameter("@TASK_DESCRIPTION", SqlDbType.NChar, 200));
                                sqlCommand.Parameters["@TASK_DESCRIPTION"].Value = Program.formMain.textBox17.Text;

                                if (Program.formMain.textBox16.Text.Length != 0)
                                {
                                    sqlCommand.Parameters.Add(new NpgsqParameter("@TASK_STATUS", SqlDbType.NChar, 15));
                        ...
                        case "Departament":
                            ...
                            else
                            {
                                ...
                                sqlCommand.Parameters.Add(new NpgsqParameter("@DEPARTAMENT_NAME", SqlDbType.NChar, 35));
                                sqlCommand.Parameters["@DEPARTAMENT_NAME"].Value = Program.formMain.textBox9.Text;

                                sqlCommand.Parameters.Add(new NpgsqParameter("@DEPARTAMENT_FLOOR", SqlDbType.NChar, 10));
                                sqlCommand.Parameters["@DEPARTAMENT_FLOOR"].Value = Program.formMain.textBox8.Text;

                                sqlCommand.Parameters.Add(new NpgsqParameter("@DEPARTAMENT_CABINET", SqlDbType.NChar, 10));
                        ...
                        case "Employee_Task":
                            ...
                            else
                            {
                                ...
                                sqlCommand.Parameters.Add(new NpgsqParameter("@EMPLOYEE_ID", SqlDbType.Int));
                                sqlCommand.Parameters["@EMPLOYEE_ID"].Value = Convert.ToInt32(Program.formMain.textBox25.Text);

                                sqlCommand.Parameters.Add(new NpgsqParameter("@TASK_ID", SqlDbType.Int));
                        ...
                        case "Task_Programmer":
                            ...
                            else
                            {
                                ...
                                sqlCommand.Parameters.Add(new NpgsqParameter("@PROGRAMMER_ID", SqlDbType.Int));
                        ...
                        case "Autorization":
                            ...
                            else
                            {
                                ...
                                sqlCommand.Parameters.Add(new NpgsqParameter("@login", SqlDbType.NVarChar, 16));
                                sqlCommand.Parameters["@login"].Value = Program.formMain.textBox23.Text;

                                sqlCommand.Parameters.Add(new NpgsqParameter("@password", SqlDbType.NVarChar, 16));
                                sqlCommand.Parameters["@password"].Value = Program.formMain.textBox21.Text;

                                sqlCommand.Parameters.Add(new NpgsqParameter("@position", SqlDbType.NChar, 10));
                ...
                try
                {
                    /*switch (Program.formMain.comboBox.Text)
                    {
                        ...
                        case "Programmer":
                            ...
                            break;
                        case "Task":
                            sqlCommand.Parameters.Add(new NpgsqParameter("@Name", SqlDbType.NChar, 50));
